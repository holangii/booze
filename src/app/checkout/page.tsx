    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Review your selected items and join our waiting list</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">
                Your Items ({getTotalItems()} {getTotalItems() === 1 ? 'item' : 'items'})
              </h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 sticky top-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Join Waiting List</h2>
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      <span>Register me on waiting list</span>
                    </>
                  )}
                </button>
              </form>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <span>Free notifications via email</span>
                </div>
