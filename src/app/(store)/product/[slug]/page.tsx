...
import { products as allProducts } from "@/app/objects/products";
...
export const generateMetadata = async (props: {
	...
	const variants = allProducts.filter((product) => product.metadata.slug === params.slug);
...
// 					const trieveMetadata = product as unknown as TrieveProductMetadata;
// 					return (
// 						<div key={product.id} className="bg-card rounded overflow-hidden shadow-sm group">
// 							{trieveMetadata.image_url && (
// 								<YnsLink href={`${publicUrl}${product.metadata.slug}`} className="block" prefetch={false}>
// 									<Image
// 										className={
...
// 									<YnsLink href={product.url || "#"} className="hover:text-primary" prefetch={false}>
// 										{trieveMetadata.name}
// 									</YnsLink>
// 								</h3>
